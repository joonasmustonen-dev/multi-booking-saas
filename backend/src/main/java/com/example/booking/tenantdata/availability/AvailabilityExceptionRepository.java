...
public interface AvailabilityExceptionRepository
    ...
    List<AvailabilityException> findByResourceIdOrderByStartAtAsc(UUID resourceId);
    ...
    List<AvailabilityException> findByStaff_IdAndScheduleWeek(UUID staffId, java.time.LocalDate scheduleWeek);
}