...
public interface AvailabilityRuleRepository
    ...
    List<AvailabilityRule> findByResourceIdOrderByStartTimeAsc(
        UUID resourceId
    );

    List<AvailabilityRule> findByStaff_IdOrderByDayOfWeekAscStartTimeAsc(UUID id);
    List<AvailabilityRule> findByLocation_IdOrderByDayOfWeekAscStartTimeAsc(UUID id);
    List<AvailabilityRule> findByResource_IdOrderByDayOfWeekAscStartTimeAsc(UUID id);
