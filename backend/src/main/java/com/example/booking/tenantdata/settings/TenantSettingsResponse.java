...
public record TenantSettingsResponse(
    ...
    public TenantSettingsResponse(String timeZone) {
        this(
            timeZone,
            "Booking workspace",
            "",
    ...
    static TenantSettingsResponse from(TenantSettings entity) {
        return new TenantSettingsResponse(
            ...
            entity.getSlotIntervalMinutes(),
            entity.getMinimumNoticeMinutes(),
            entity.getBookingHorizonDays(),
            entity.getCalendarStartHour(),
            entity.getCalendarEndHour(),
            entity.getWeekStartsOn(),
            entity.getDefaultAppointmentStatus()
        );
    }
}
