...
public class LocationController {
    ...
    @GetMapping("/{id}")
    public LocationResponse findById(@PathVariable UUID id) { return service.findById(id); }
    @PostMapping
    ...
    public LocationResponse setActive(@PathVariable UUID id, @Valid @RequestBody AssignmentActiveRequest request) {
